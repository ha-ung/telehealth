...
public class MultiSpinner extends androidx.appcompat.widget.AppCompatSpinner implements DialogInterface.OnMultiChoiceClickListener, DialogInterface.OnCancelListener {
    ...
    public void setItems(List<String> items, String altText, MultiSpinnerListener listener) {
        this.items = items;
        this.defaultText = altText;
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getContext(), android.R.layout.simple_spinner_item, new String[] { altText });
        setAdapter(adapter);
    }
